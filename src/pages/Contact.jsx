    ...
    <div className="bg-black min-h-screen">
      <div className="bg-neutral-950 border-b border-neutral-800 px-6 py-10">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-neutral-500 text-sm mt-1">Our team of Euro specialists is ready to help</p>
        </div>
      </div>
          ...
          <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-white text-black text-xs font-black tracking-widest uppercase py-4 hover:bg-neutral-200 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
              >
