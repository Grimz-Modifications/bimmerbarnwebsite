...
export const PRODUCTS = [
  ...
  // --- ENGINE ---
  { id: "1",  name: "Dinan Stage 1 Performance Tune",           price: 749,   sale_price: null,  category: "engine",       brand_compatibility: ["BMW"], model_compatibility: "E90 335i · E92 335i · E60 535i",   in_stock: true,  featured: true,  part_number: "DIN-N54-S1",         manufacturer: "Dinan",            image_url: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&h=600&fit=crop&q=80",  description: "ECU software calibration for N54 engines. Increases power output and throttle response. Plug-and-play installation." },
  ...
  { id: "e1", name: "Eisenmann Race Exhaust E46 M3",            price: 1850,  sale_price: null,  category: "exhaust",      brand_compatibility: ["BMW"], model_compatibility: "E46 M3",                           in_stock: true,  featured: false, part_number: "EIS-E46-RACE",       manufacturer: "Eisenmann",        image_url: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=600&fit=crop&q=80",  description: "Quad-tip race exhaust for E46 M3. Deep, aggressive S54 sound with improved flow." },

  // --- SUSPENSION ---
  { id: "3",  name: "KW Variant 3 Coilover Kit — E9X",         price: 2199,  sale_price: null,  category: "suspension",   brand_compatibility: ["BMW"], model_compatibility: "E90 · E92 · E93",                  in_stock: true,  featured: true,  part_number: "KW-V3-E9X",          manufacturer: "KW Suspension",    image_url: "https://images.unsplash.com/photo-1600712242805-5f78671b24da?w=600&h=600&fit=crop&q=80",  description: "Independently adjustable rebound and compression damping. Lowers ride height and dramatically improves handling." },
  { id: "e2", name: "Bilstein PSS10 Coilover Kit — E46",        price: 1599,  sale_price: 1399, category: "suspension",   brand_compatibility: ["BMW"], model_compatibility: "E46 328i · 330i · M3",             in_stock: true,  featured: false, part_number: "BIL-PSS10-E46",      manufacturer: "Bilstein",         image_url: "https://images.unsplash.com/photo-1600712242805-5f78671b24da?w=600&h=600&fit=crop&q=80",  description: "10-way adjustable damping with OEM-quality ride. Ideal street/track balance for E46." },

  // --- INTAKE ---
  { id: "4",  name: "Burger Motorsports BMS Intake — N54",      price: 299,   sale_price: 249,   category: "intake",       brand_compatibility: ["BMW"], model_compatibility: "E90/E92 335i · E60 535i · E89 Z4", in_stock: true,  featured: false, part_number: "BMS-N54-CAI",        manufacturer: "BMS",              image_url: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&h=600&fit=crop&q=80",  description: "High-flow cold air intake for N54 engines. Easy install with no cutting or modification required." },
  ...
  // --- EXTERIOR ---
  { id: "e3", name: "E46 M3 Carbon Fiber Hood",                 price: 899,   sale_price: 749,   category: "exterior",     brand_compatibility: ["BMW"], model_compatibility: "E46 M3",                           in_stock: true,  featured: false, part_number: "CF-HOOD-E46M3",      manufacturer: "Seibon",           image_url: "https://images.unsplash.com/photo-1555215695-3004980ad54e?w=600&h=600&fit=crop&q=80",  description: "OEM-style carbon fiber hood for E46 M3. Significant weight savings over stock steel hood." },

  // --- WHEELS & TIRES ---
  { id: "7",  name: "Apex Arc-8 Wheels 18x10",                  price: 1850,  sale_price: null,  category: "wheels_tires", brand_compatibility: ["BMW"], model_compatibility: "E46 · E90 · E92",                  in_stock: false, featured: false, part_number: "ARC8-18X10-SB",     manufacturer: "Apex",             image_url: "https://images.unsplash.com/photo-1611821064430-0d40291d0f0b?w=600&h=600&fit=crop&q=80",  description: "Forged monoblock construction, extreme lightweight. Available in Satin Black. Square or staggered setups." },
  ...
  // --- ENGINE ---
  { id: "f1", name: "Dinan Stage 2 Tune — F30 N55",             price: 1299,  sale_price: null,  category: "engine",       brand_compatibility: ["BMW"], model_compatibility: "F30 335i · F32 435i",              in_stock: true,  featured: false, part_number: "DIN-N55-S2",         manufacturer: "Dinan",            image_url: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&h=600&fit=crop&q=80",  description: "Stage 2 ECU tune for F-chassis N55. Includes upgraded VRSF charge pipe. Gains up to 80whp over stock." },
  { id: "f2", name: "Pure Stage 2 Turbo — F80 M3 S55",          price: 3800,  sale_price: null,  category: "engine",       brand_compatibility: ["BMW"], model_compatibility: "F80 M3 · F82 M4 · F87 M2 Comp",   in_stock: true,  featured: true,  part_number: "PURE-S55-STG2",      manufacturer: "Pure Turbos",      image_url: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&h=600&fit=crop&q=80",  description: "Drop-in upgraded turbos for S55. Supports 600+whp. Best power-per-dollar for F8X platform." },

  // --- EXHAUST ---
  { id: "f3", name: "VRSF Catless Downpipes — F30 N55",         price: 499,   sale_price: 449,   category: "exhaust",      brand_compatibility: ["BMW"], model_compatibility: "F30 335i · F32 435i · F10 535i",   in_stock: true,  featured: false, part_number: "VRSF-DP-N55",        manufacturer: "VRSF",             image_url: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=600&fit=crop&q=80",  description: "3\" catless downpipes for N55 F-chassis. Significant power gains and aggressive exhaust note." },
  { id: "f4", name: "Akrapovic Titanium Exhaust — F80 M3",      price: 4200,  sale_price: null,  category: "exhaust",      brand_compatibility: ["BMW"], model_compatibility: "F80 M3 · F82 M4",                  in_stock: true,  featured: false, part_number: "AKR-F8X-TI",         manufacturer: "Akrapovic",        image_url: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=600&fit=crop&q=80",  description: "Full titanium slip-on system for F8X M3/M4. Weight savings of 7kg over OEM. Incredible sound." },

  // --- SUSPENSION ---
  { id: "3b", name: "KW Variant 3 Coilover Kit — F80 M3/M4",   price: 2599,  sale_price: null,  category: "suspension",   brand_compatibility: ["BMW"], model_compatibility: "F80 M3 · F82 M4",                  in_stock: true,  featured: true,  part_number: "KW-V3-F8X",          manufacturer: "KW Suspension",    image_url: "https://images.unsplash.com/photo-1600712242805-5f78671b24da?w=600&h=600&fit=crop&q=80",  description: "Independently adjustable rebound and compression damping for F8X platform. Lowers ride height 10–30mm." },
  { id: "f5", name: "Eibach Pro-Street Coilovers — F30",        price: 1199,  sale_price: 1049, category: "suspension",   brand_compatibility: ["BMW"], model_compatibility: "F30 320i · 328i · 335i",            in_stock: true,  featured: false, part_number: "EIB-PS-F30",         manufacturer: "Eibach",           image_url: "https://images.unsplash.com/photo-1600712242805-5f78671b24da?w=600&h=600&fit=crop&q=80",  description: "Height and damping adjustable coilover for F30. Great daily driver upgrade with sport bias." },

  // --- INTAKE ---
  { id: "f6", name: "VRSF High Flow Intake — F80 M3 S55",      price: 349,   sale_price: null,  category: "intake",       brand_compatibility: ["BMW"], model_compatibility: "F80 M3 · F82 M4 · F87 M2 Comp",   in_stock: true,  featured: false, part_number: "VRSF-INT-S55",       manufacturer: "VRSF",             image_url: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&h=600&fit=crop&q=80",  description: "High-flow dual cone intake kit for S55. Significant intake sound improvement and modest power gains." },
  ...
  // --- ENGINE ---
  { id: "g1", name: "Bootmod3 Stage 1 Tune — G20 B58",          price: 599,   sale_price: null,  category: "engine",       brand_compatibility: ["BMW"], model_compatibility: "G20 330i/M340i · G30 540i",        in_stock: true,  featured: true,  part_number: "BM3-B58-S1",         manufacturer: "ProTuning Freaks", image_url: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&h=600&fit=crop&q=80",  description: "Remote flash ECU tune for B58 G-chassis. Stage 1 adds ~80whp on 93 octane. OTA updates included." },
  { id: "g2", name: "Pure Stage 1 Turbos — G80 M3 S58",         price: 4500,  sale_price: null,  category: "engine",       brand_compatibility: ["BMW"], model_compatibility: "G80 M3 · G82 M4 · G87 M2",         in_stock: true,  featured: false, part_number: "PURE-S58-STG1",      manufacturer: "Pure Turbos",      image_url: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&h=600&fit=crop&q=80",  description: "Upgraded drop-in turbos for S58 platform. Supports 650+whp with supporting mods. Warranty-friendly." },

  // --- EXHAUST ---
  { id: "g3", name: "VRSF Downpipes — G80 M3 S58",              price: 799,   sale_price: 699,   category: "exhaust",      brand_compatibility: ["BMW"], model_compatibility: "G80 M3 · G82 M4 · G87 M2",         in_stock: true,  featured: false, part_number: "VRSF-DP-S58",        manufacturer: "VRSF",             image_url: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=600&fit=crop&q=80",  description: "Catless or high-flow cat downpipes for S58. Significant power gains and raw exhaust note." },
  { id: "g4", name: "Akrapovic Slip-On Exhaust — G80 M3",        price: 3600,  sale_price: null,  category: "exhaust",      brand_compatibility: ["BMW"], model_compatibility: "G80 M3 Competition · G82 M4",      in_stock: true,  featured: false, part_number: "AKR-G8X-SO",         manufacturer: "Akrapovic",        image_url: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=600&fit=crop&q=80",  description: "Titanium slip-on exhaust for G8X. Race-grade sound, 4kg weight savings. No tune required." },

  // --- SUSPENSION ---
  { id: "g5", name: "KW Variant 4 Coilovers — G80 M3 xDrive",   price: 3299,  sale_price: null,  category: "suspension",   brand_compatibility: ["BMW"], model_compatibility: "G80 M3 xDrive · G82 M4 xDrive",    in_stock: true,  featured: false, part_number: "KW-V4-G8X",          manufacturer: "KW Suspension",    image_url: "https://images.unsplash.com/photo-1600712242805-5f78671b24da?w=600&h=600&fit=crop&q=80",  description: "4-way adjustable coilovers for G8X xDrive. Works with factory active suspension system." },
  { id: "g6", name: "H&R Sport Springs — G20 330i/M340i",        price: 299,   sale_price: 269,   category: "suspension",   brand_compatibility: ["BMW"], model_compatibility: "G20 330i · M340i",                 in_stock: true,  featured: false, part_number: "HR-SPR-G20",         manufacturer: "H&R",              image_url: "https://images.unsplash.com/photo-1600712242805-5f78671b24da?w=600&h=600&fit=crop&q=80",  description: "Lowering springs for G20. Drops ~25mm front and rear. Retains factory shock absorbers." },

  // --- INTAKE ---
  { id: "g7", name: "Eventuri Carbon Intake — G80 M3 S58",       price: 1299,  sale_price: null,  category: "intake",       brand_compatibility: ["BMW"], model_compatibility: "G80 M3 · G82 M4 · G87 M2",         in_stock: true,  featured: false, part_number: "EVN-S58-INT",        manufacturer: "Eventuri",         image_url: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&h=600&fit=crop&q=80",  description: "Full carbon fiber intake system for S58. Dramatically improves induction sound and airflow." },
