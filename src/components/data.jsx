...
export const PRODUCTS = [
  ...
  // --- EXHAUST ---
  { id: "2",  name: "Active Autowerke Catback Exhaust",         price: 1295,  sale_price: 1099,  category: "exhaust",      brand_compatibility: ["BMW"], model_compatibility: "E90 · E92 · E93 M3",               in_stock: true,  featured: true,  part_number: "AA-E9X-CB",          manufacturer: "Active Autowerke", image_url: "https://images.unsplash.com/photo-1540066019607-e5f69323a8dc?w=600&h=600&fit=crop&q=80",  description: "Stainless steel catback exhaust system with aggressive tone and improved flow. Bolt-on fitment for E9x M3." },
